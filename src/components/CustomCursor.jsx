  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(245,185,66,0.2) 0%, rgba(245,185,66,0.06) 45%, transparent 75%)'
        }}
      ></div>
      ...
      <div
        ref={dotRef}
        className="fixed top-0 left-0 z-[9999] pointer-events-none w-3 h-3 bg-[#f5b942] rounded-full shadow-[0_0_15px_#f5b942] hidden lg:block"
      ></div>

      {/* Global Custom Cursor Ring */}
      <div
        ref={ringRef}
        className="fixed top-0 left-0 z-[9999] pointer-events-none w-12 h-12 border border-[#f5b942]/60 rounded-full flex items-center justify-center backdrop-blur-[1px] hidden lg:block"
      ></div>
    </>
  );
};
